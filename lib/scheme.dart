...
import '../../../domain/models/extended_color.dart';
import '../../../domain/models/material_scheme.dart';
...
class _SchemePreviewState extends State<SchemePreview> {
  ...
  void didUpdateWidget(covariant SchemePreview oldWidget) {
    if (
        oldWidget.colorMatch != widget.colorMatch ||
        oldWidget.extendedColors != widget.extendedColors) {
      if (mounted) setState(() {});
    }
